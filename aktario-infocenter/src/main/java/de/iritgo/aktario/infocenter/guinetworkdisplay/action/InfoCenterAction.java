...
public class InfoCenterAction extends FrameworkAction
{
	 ...
	 *
	 */
	public InfoCenterAction (int context, String category, String icon, String message, String guiPaneId,
	...
	public void perform ()
	{
		AddInfoToGUIDisplay displayCmd = new AddInfoToGUIDisplay (context, category, icon, message, guiPaneId,
