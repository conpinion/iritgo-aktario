...
/**
 * A logger that displays the log messages in a dialog.
 */
public class DialogLogger implements Logger
{
	/** The current time. */
	...
	/** The log message dialog. */
	private JDialog dialog;

	/** The text pane containing the log messages. */
