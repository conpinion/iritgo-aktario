...
/**
 * @version $Id: RemoteControlAction.java,v 1.5 2006/09/25 10:34:32 grappendorf Exp $
 */
public class RemoteControlAction extends FrameworkAction
{
	...
	/** Remote control a clear all text. */
	public static final int CONTROL_TEXT_CLEAR = 12;

	/** Remote control a clear all text. */
	public static final int CONTROL_TEXT_INSERT = 13;

	/** Remote control the file name. */
	public static final int CONTROL_FILE_NAME = 14;
	...
	public void perform()
	{
		...
		EditorPane pane = (EditorPane) appPane;
