...
/**
 * This command set the base dir for the aktario editor tool
 *
 * @version $Id: BaseDirCommand.java,v 1.5 2006/09/25 10:34:32 grappendorf Exp $
 */
public class BaseDirCommand extends Command
{
	private EditorPane sofwareReviewPane;
